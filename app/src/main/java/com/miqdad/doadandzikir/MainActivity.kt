...
import com.miqdad.doadandzikir.adapter.Artikel
import com.miqdad.doadandzikir.adapter.ArtikelAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setUpViewPager() {
        val llSliderDot: LinearLayout = findViewById(R.id.ll_slider_dots)
        ...
        for (i in 0 until listArtikel.size) {
            ...
            //menerapkan params sebagai aturan bagaimana indicator yang ditampilkan
    ...
    private fun initView() {
        ...
        llDzikirSetiapSaat.setOnClickListener {
            startActivity(Intent(this, SetiapSaatActivity::class.java))
        }
        ...
        vpArtikel.setOnClickListener{
            startActivity(Intent(this, DetailArtikelActivity::class.java))
        }
